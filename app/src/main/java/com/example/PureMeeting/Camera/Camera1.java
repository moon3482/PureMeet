package com.example.PureMeeting.Camera;
...
public class Camera1 extends AppCompatActivity
    ...
    private com.example.PureMeeting.Camera.CameraPreview mCameraPreview;
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
                    ...
                    Snackbar.make(mLayout, "이 앱을 실행하려면 카메라와 외부 저장소 접근 권한이 필요합니다.",
                        ...
                        public void onClick(View view) {
                            ...
                            ActivityCompat.requestPermissions(com.example.PureMeeting.Camera.Camera1.this, REQUIRED_PERMISSIONS,
    ...
    void startCamera() {
        ...
        mCameraPreview = new com.example.PureMeeting.Camera.CameraPreview(this, this, CAMERA_FACING_FRONT, surfaceView);
